'''
  This script is currently designed to take 4 second videos from the GoPro and download each file, with a wait 
  time of 4 seconds between each recording so the camera can catch up.
